...
export default function ChatPage() {
  return (
    <Tabs defaultValue="Homely" className="w-full flex bg-primary overflow-hidden">
      ...
      {chats.map((data) => (
        <TabsContent className="w-3/4 max-h-screen bg-background overflow-y-hidden" key={data._id} value={data._id}>
